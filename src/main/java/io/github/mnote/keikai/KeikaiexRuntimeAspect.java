...
@Aspect
public class KeikaiexRuntimeAspect {

    private static final Logger logger = LoggerFactory.getLogger(KeikaiexRuntimeAspect.class);

    @Pointcut(value="execution(static boolean io.keikaiex.rt.Runtime.init(org.zkoss.zk.ui.WebApp, boolean)) && args(webApp,flag)", argNames="webApp,flag")
    ...
    public boolean init(ProceedingJoinPoint joinPoint, WebApp webApp, boolean flag) throws Throwable {
        ...
        String ZK_NOTICE = Reflect.onClass("io.keikaiex.rt.Runtime").get("ZK_NOTICE");
        String EVAL_ONLY = Reflect.onClass("io.keikaiex.rt.Runtime").get("EVAL_ONLY");
    ...
    @Around("execution(boolean io.keikaiex.rt.Runtime$Init1.validate(org.zkoss.zk.ui.event.Event)) ")
    ...
    @Around("execution(boolean io.keikaiex.rt.Runtime$Init1.validUptime(org.zkoss.zk.ui.event.Event)) ")
    ...
    @Around("execution(void io.keikaiex.rt.Runtime$Init1.showWin(..)) ")
    ...
    @Around("execution(void io.keikaiex.rt.Runtime$Init1.maskSheetSession(..)) ")
    ...
    @Around("execution(void io.keikaiex.rt.Runtime$Init1.complainLicense(org.zkoss.zk.ui.event.Event)) ")
    ...
    @Around("execution(void io.keikaiex.rt.Runtime$Init1.complainUptime(org.zkoss.zk.ui.event.Event)) ")
